...
/**
 * Fournisseur de données temps réel pour N3PP (serre / élevage).
 * Implémente le contrat commun pour realtime-updater.js / control-sync.js.
 */
class N3ppRealtimeDataProvider implements RealtimeDataProviderInterface
{
    private const ONLINE_THRESHOLD_SECONDS = 600;
    private const DEFAULT_BOARD = 3;
    ...
    {
        $sensors = [];
        foreach (N3ppSensorRepository::SENSOR_COLUMNS as $col) {
