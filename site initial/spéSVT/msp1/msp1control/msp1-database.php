...
$password = "Iot#Olution1";
    ...
    function createOutput($mail, $mailNotif, $SeuilSec, $HeureArrosage, $tempsArrosage) {
        ...
        $sql = "UPDATE msp1Outputs SET state = '" . $mail . "' WHERE gpio= '100';
        UPDATE msp1Outputs SET state = '" . $mailNotif . "' WHERE gpio= '101';
        UPDATE msp1Outputs SET state = '" . $SeuilSec . "' WHERE gpio= '102';
        UPDATE msp1Outputs SET state = '" . $HeureArrosage . "' WHERE gpio= '103';
        UPDATE msp1Outputs SET state = '" . $tempsArrosage . "' WHERE gpio= '104';
        ";
    ...
    function deleteOutput($id) {
        ...
        $sql = "DELETE FROM msp1Outputs WHERE id='". $id .  "'";
    ...
    function updateOutput($id, $state) {
        ...
        $sql = "UPDATE msp1Outputs SET state='" . $state . "' WHERE id='". $id .  "'";
    ...
    function getAllOutputs() {
        ...
        $sql = "SELECT id, name, board, gpio, state FROM msp1Outputs ORDER BY id";
    ...
    function getPartOutputs() {
        ...
        $sql = "SELECT id, name, board, gpio, state FROM msp1Outputs ORDER BY id limit 3";
        if ($result = $conn->query($sql)) {
            return $result;
        }
        else {
    ...
    function getAllOutputStates($board) {
        ...
        $sql = "SELECT gpio, state FROM msp1Outputs WHERE board='" . $board . "'";
        if ($result = $conn->query($sql)) {
            return $result;
        }
        else {
    ...
    function getOutputBoardById($id) {
        ...
        $sql = "SELECT board FROM msp1Outputs WHERE id='" . $id . "'";
        if ($result = $conn->query($sql)) {
            return $result;
        }
        else {
