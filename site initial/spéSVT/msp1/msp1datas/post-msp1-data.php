...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if($api_key == $api_key_value) {
        ...
        $sql = "INSERT INTO msp1Data (sensor, version, TempAir, Humidite, Luminosite, Humid1, Humid2, Humid3, Humid4, HumidMoy, ArrosageManu, SeuilSec, mail, mailNotif, HeureArrosage, resetMode, etatPompe, tempsArrosage)
