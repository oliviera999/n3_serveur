...
class PumpService
{
    ...
    {
        return $this->getState(self::GPIO_POMPE_AQUA);
    }

    public function getTankPumpState(): ?int
    {
        return $this->getState(self::GPIO_POMPE_TANK);
    }

    public function getResetModeState(): ?int
    {
        return $this->getState(self::GPIO_RESET_MODE);
    }

    public function rebootEsp(): void
    {
        $this->setState(self::GPIO_RESET_MODE, 1);
    }
} 