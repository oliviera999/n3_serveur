...
<html>
    ...
    <script>
        function updateOutput(element) {
            ...
            if(element.checked){
                xhr.open("GET", "https://iot.olution.info/ffp3/ffp3control/ffp3-outputs-action2.php?action=output_update&id="+element.id+"&state=1", true);
            }
            else {
                xhr.open("GET", "https://iot.olution.info/ffp3/ffp3control/ffp3-outputs-action2.php?action=output_update&id="+element.id+"&state=0", true);
            }
            xhr.send();
        }
        ...
        function deleteOutput(element) {
            ...
            if (result) {
                var xhr = new XMLHttpRequest();
                xhr.open("GET", "https://iot.olution.info/ffp3/ffp3control/ffp3-outputs-action2.php?action=output_delete&id="+element.id, true);
                xhr.send();
