<?php
    ...
    $action = $id = $mail = $mailNotif = $SeuilSec = $SeuilPontDiv = $HeureArrosage = $tempsArrosage = $WakeUp = $FreqWakeUp ;
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($action == "output_create") {
            ...
            $result = createOutput($mail, $mailNotif, $SeuilSec, $SeuilPontDiv, $HeureArrosage, $tempsArrosage, $WakeUp, $FreqWakeUp);
