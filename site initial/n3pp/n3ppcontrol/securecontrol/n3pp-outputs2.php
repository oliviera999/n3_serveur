					...
					<div id="main">
						 <!-- Featured Post -->
							<article class="post featured">
								<header class="major">
                                    ...
                                    <div>
                                        <form onsubmit="return createOutput();">
                                            ...
                                            <label for="outputBoard">Limite de sécheresse</label>
                                            <input type="number" name="board" min="0" id="outputBoard" value=<?php echo $SeuilSec; ?>>
                                            <label for="outputGpio">Heure arrosage</label>
                                            <input type="number" name="gpio" min="0" id="outputGpio" value=<?php echo $HeureArrosage; ?>>                               
                                ...
                                <div>
                                    <center>                         
                                        <a href="https://iot.olution.info/ffp3/n3ppdatas/n3pp-data.php" class="button large">Retour aux données</a>
                                    </center>
                                </div>
                            </article>
                        </div>
