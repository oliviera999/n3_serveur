...
CREATE TABLE IF NOT EXISTS `ffp3Data` (
  ...
  `tideEvent` VARCHAR(16) DEFAULT NULL,
  `tideTrend` TINYINT DEFAULT NULL,
  `tideNoiseMm` SMALLINT UNSIGNED DEFAULT NULL,
  `tideWindowMs` INT UNSIGNED DEFAULT NULL,
  `tideExtremeMm` SMALLINT UNSIGNED DEFAULT NULL,
