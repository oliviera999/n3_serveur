# CHANGELOG archive — 5.0.201 → 5.0.267

Archive automatique générée lors de la rotation rolling window (v5.1.0).
Pour les entrées plus récentes voir [`../../../CHANGELOG.md`](../../../CHANGELOG.md).
