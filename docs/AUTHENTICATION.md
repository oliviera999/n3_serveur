...
- APIs sensibles (écriture) : `POST /api/outputs/toggle`, `POST /api/outputs/parameters`, `POST /api/outputs/trigger-ota-check`, `POST /gallery/{slug}/api/outputs/toggle` (POST uniquement depuis 6.37.4), et équivalents `*-test`, `outputs3*`, etc.
