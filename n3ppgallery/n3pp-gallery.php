				 ...
				 <!-- Nav -->
					<nav id="nav">
						<ul class="links">
							...
							<li><a href="https://iot.olution.info/ffp3/ffp3datas/ffp3-data.php">farmflow</a></li>
								...
								<!-- <section class="posts"> -->
                                    ...
                                    <?php
                                      ...
                                      if (is_dir($dir)){
                                        ...
                                        rsort($files);
                                        if($_GET['page'] > 1)
                                            $prev_link = '<a href="n3pp-gallery.php?page='.($_GET['page']-1).'" class="button primary fit"> page précédente </a>';
                                        if($_GET['page'] < $max_pages)
                                            $next_link = '<a href="n3pp-gallery.php?page='.($_GET['page']+1).'" class="button primary fit"> page suivante </a>';
