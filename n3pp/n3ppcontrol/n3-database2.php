...
$password = "Iot#Olution1";
    ...
    function createOutput($name, $board, $gpio, $state) {
        ...
        $sql = "INSERT INTO Outputs2 (name, board, gpio, state)
    ...
    function deleteOutput($id) {
        ...
        $sql = "DELETE FROM Outputs2 WHERE id='". $id .  "'";
    ...
    function updateOutput($id, $state) {
        ...
        $sql = "UPDATE Outputs2 SET state='" . $state . "' WHERE id='". $id .  "'";
    ...
    function getAllOutputs() {
        ...
        $sql = "SELECT id, name, board, gpio, state FROM Outputs2 ORDER BY board";
    ...
    function getAllOutputStates($board) {
        ...
        $sql = "SELECT gpio, state FROM Outputs2 WHERE board='" . $board . "'";
        if ($result = $conn->query($sql)) {
            return $result;
        }
        else {
    ...
    function getOutputBoardById($id) {
        ...
        $sql = "SELECT board FROM Outputs2 WHERE id='" . $id . "'";
        if ($result = $conn->query($sql)) {
            return $result;
        }
        else {
