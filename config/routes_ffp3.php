...
$ffp3RoutesConfig = [
    'prod' => [
        ...
        'trigger_feed' => '/api/outputs/trigger-feed',
    ...
    'test' => [
        ...
        'trigger_feed' => '/api/outputs-test/trigger-feed',
    ...
    'test3' => [
        ...
        'trigger_feed' => '/api/outputs3-test/trigger-feed',
    ...
    's3' => [
        ...
        'trigger_feed' => '/api/outputs3/trigger-feed',
    ...
    's3test' => [
        ...
        'trigger_feed' => '/api/outputs-s3-test/trigger-feed',
